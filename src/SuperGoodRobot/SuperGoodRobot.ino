...
enum RobotMenu {
	NO_MENU, MAIN_MENU, PLAN_MENU, STATE_MENU, TAPE_MENU, NUM_MENU
};
...
RobotState lastState = INITIALISING; //don't know if we need this, we might not

RobotMenu currentMenu = NO_MENU;
